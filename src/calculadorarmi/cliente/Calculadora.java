...
import calculadorarmi.servidor.IStub;
...
public class Calculadora extends javax.swing.JFrame {
    ...
    public Calculadora() throws RemoteException, NotBoundException, MalformedURLException {
        initComponents();
        Registry registro = LocateRegistry.getRegistry("localhost");
        calc = (IStub) Naming.lookup("rmi://localhost:1999/servico");
    }
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        try {
            if (value.contains("+")) {
                ...
                tfValue.setText(calc.realizaCalculo(Float.parseFloat(valores[0]), "+",
